...
import { getAdminBreadcrumb } from '@/utils/adminNavConfig';

export default function AdminTopBar({ user, pathname, onMenuClick, onLogout }) {
  const crumbs = getAdminBreadcrumb(pathname);

  return (
    <header className="admin-topbar portal-shell-topbar sticky top-3 z-40">
