-- Tatva Direct Database Schema for Supabase (PostgreSQL)
...
CREATE INDEX idx_users_profile_categories ON users USING GIN ((profile->'categories'));
...
CREATE INDEX idx_boqs_service_provider ON boqs(service_provider_id);
...
CREATE INDEX idx_boq_items_normalized_product ON boq_items(normalized_product_id);
...
CREATE INDEX idx_orders_service_provider ON orders(service_provider_id);
CREATE INDEX idx_orders_supplier ON orders(supplier_id);
CREATE INDEX idx_orders_status ON orders(status);
CREATE INDEX idx_orders_created_at ON orders(created_at DESC);
CREATE INDEX idx_orders_payment_status ON orders(payment_status);
CREATE INDEX idx_orders_boq ON orders(boq_id);
...
CREATE INDEX idx_supplier_ratings_sp ON supplier_ratings(service_provider_id);
...
CREATE INDEX idx_payment_receipts_supplier ON payment_receipts(supplier_id);
CREATE INDEX idx_payment_receipts_service_provider ON payment_receipts(service_provider_id);
